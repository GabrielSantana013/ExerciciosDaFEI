...
void bubble_sort(int vetor[], int tamanho, PerformanceStats *stats) {
...
void insertion_sort(int vetor[], int tamanho, PerformanceStats *stats) {
    ...
    for(int i = 1; i < tamanho; i++){
        ...
        if(j >= 0) {
            stats->comparisons++; // For the last comparison when while condition fails
        }
        vetor[j + 1] = key;
    }
}

void selection_sort(int vetor[], int tamanho, PerformanceStats *stats) {
